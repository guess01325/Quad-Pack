...
import { getAllLuggageItems, postLuggage, putLuggage, deleteLuggage, getOneLuggage } from "../services/luggages";
...
export default function LuggageContainer (props){
  ...
  const handleDeleteLuggage = async (id) => {
    ...
    setLuggage((prevState) =>
    prevState.filter((luggage) => luggage.id !== id)
    );
  };
    ...
    return (
        ...
        <Switch>
           ...
           <LuggageCreate luggage={luggage} handleCreateLuggage={handleCreateLuggage}/>
            </Route>
            <Route path="/events/:eventId/luggage/:id/edit">
             <LuggageEdit luggage={luggage}handleUpdateLuggage={handleUpdateLuggage} />
            </Route>
            <Route path="/events/:eventId/luggages">
            <EventDetails event={event} luggage={luggage} getAllLuggageItems={getAllLuggageItems} handleDeleteLuggage={handleDeleteLuggage} getOneLuggage={getOneLuggage}/>
            </Route>
